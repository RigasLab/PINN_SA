...
from PeriodicHills.PeriodicHillFunctions import genH, genHArr, getBSLHill

import numpy as np

class PeriodicHillDDEGeometryBase(dde.geometry.geometry.Geometry):
    def __init__(
        self,
        ):
        ...
        super(PeriodicHillDDEGeometryBase, self).__init__(
