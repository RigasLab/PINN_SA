...
##################################################################################
##################################################################################
[domain, pde, bc, loss_name, loss_weights, netShape, transform, func_sol, X_anchor, path_list, aux_D] = initCase(case,getAnchor,test_name,other,pde_type,weights,resolution)
